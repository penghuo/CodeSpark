...
sql="SELECT count(*) FROM flint.http_logs_streaming"
...
aws emr-serverless start-job-run \
  ...
  --configuration-overrides '{"monitoringConfiguration":{"s3MonitoringConfiguration":{"logUri":"s3://flint-data-for-integ-test/log/"}}}'
